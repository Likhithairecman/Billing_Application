...
export function DashboardProvider({ children }: { children: ReactNode }) {
  ...
  const [products, setProducts] = useState<Product[]>(() => {
    ...
    return saved
      ...
      : [
        { id: "P001", name: "Product 1", revenue: 470000, price: 500, gst: "18", hsn: "1234" },
        { id: "P002", name: "Product 2", revenue: 310000, price: 1000, gst: "12", hsn: "5678" },
        { id: "P003", name: "Product 3", revenue: 140000, price: 1500, gst: "5", hsn: "9012" },
      ];
  });
